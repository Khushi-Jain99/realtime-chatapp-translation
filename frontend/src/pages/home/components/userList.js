...
function UsersList({searchKey, socket, onlineUser}){
    ...
    useEffect(() => {
        socket.off('set-message-count').on('set-message-count', (message) => {
            ...
            // Create a new array with the latest chat on top & other chats below
    ...
    const getUnreadMessageCount = (userId) => {
        ...
        if (chat && chat.unreadMessageCount && chat.lastMessage && chat.lastMessage.sender !== currentUser._id) {
